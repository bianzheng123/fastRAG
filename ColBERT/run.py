...
def build_index_official(username: str, dataset: str):
    colbert_project_path = f'/home/{username}/vector-set-similarity-search/baseline/ColBERT'
    ...
    index_path = f'/home/{username}/Dataset/vector-set-similarity-search/Index/{dataset}'
...
def retrieval_official(username: str, dataset: str, topk: int, search_config_l: list):
    ...
    index_path = f'/home/{username}/Dataset/vector-set-similarity-search/Index/{dataset}'
    result_performance_path = f'/home/{username}/Dataset/vector-set-similarity-search/Result/performance'
    result_answer_path = f'/home/{username}/Dataset/vector-set-similarity-search/Result/answer'
    ...
    for search_config in search_config_l:
        ...
        with Run().context(
            ...
            ranking, retrieval_time_l, time_ivf_l, time_filter_l, time_refine_l, n_refine_ivf_l, n_refine_filter_l = searcher.search_all_embedding_by_vector(
                query_emb=query_emb,
        ...
        # result_performance_path = f'/home/{username}/Dataset/vector-set-similarity-search/Result/single_query_performance'
...
def retrieval_end2end_single(username: str, dataset: str, topk: int, search_config_l: list):
    ...
    query_embedding_filename = os.path.join(embedding_path, 'query_embedding.npy')
    index_path = f'/home/{username}/Dataset/vector-set-similarity-search/Index/{dataset}'
    result_performance_path = f'/home/{username}/Dataset/vector-set-similarity-search/end2end/Result/performance'
    result_answer_path = f'/home/{username}/Dataset/vector-set-similarity-search/end2end/Result/answer'
    query_text_filename = os.path.join(document_data_path, 'queries.dev.tsv')
    ...
    for search_config in search_config_l:
        ...
        with Run().context(
            ...
            retrieval_suffix = f'ndocs_{searcher.config.ndocs}-ncells_{searcher.config.ncells}-' \
                               f'centroid_score_threshold_{para_score_thres}-n_thread_{search_config["n_thread"]}'
            output_path = f'/home/{username}/Dataset/vector-set-similarity-search/end2end/Result/performance'
