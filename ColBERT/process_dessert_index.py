...
def process_dataset(username: str, dataset: str):
    plaid_index_path = f'/home/{username}/vector-set-similarity-search/Dataset/{dataset}/index/plaid/'
    dessert_index_path = f'/home/{username}/vector-set-similarity-search/Dataset/{dataset}/index/dessert'
    embedding_path = f'/home/{username}/vector-set-similarity-search/Dataset/{dataset}/embedding'
