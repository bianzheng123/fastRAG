...
class IndexScorer(IndexLoader, CandidateGeneration):
    ...
    def rank(self, config, Q, filter_fn=None):
        with (torch.inference_mode()):
            ...
            scores, pids, filter_time, refine_time, n_refine_ivf, n_refine_filter = self.score_pids(config, Q, pids,
                                                                                                    centroid_scores)
            ...
            return pids, scores, ivf_time, \
                filter_time, refine_time, n_refine_ivf, n_refine_filter
    ...
    def score_pids(self, config, Q, pids, centroid_scores):
        ...
        if Q.size(0) == 1:
            ...
            return scores, pids, filter_time, refine_time, n_refine_ivf, n_refine_filter
